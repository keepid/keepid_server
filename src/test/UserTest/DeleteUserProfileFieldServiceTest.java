...
public class DeleteUserProfileFieldServiceTest {
        ...
        public void deleteNestedFieldWithDotNotation() {
                ...
                assertEquals("123 Main St",
                                updatedUser.getOptionalInformation().getBasicInfo().getMailingAddress()
                                                .getStreetAddress());
        }
        ...
        public void cannotDeleteRequiredFields() {
                ...
                DeleteUserProfileFieldService service3 = new DeleteUserProfileFieldService(userDao, "testuser",
                                "organization");
        ...
        public void deleteIndividualDemographicFields() {
                ...
                assertEquals("Philadelphia",
                                updatedUser1.getOptionalInformation().getDemographicInfo().getCityOfBirth());
                ...
                assertEquals("Philadelphia",
                                updatedUser2.getOptionalInformation().getDemographicInfo().getCityOfBirth());
        }
}
