...
public class GetDefaultIdServiceUnitTest {
  ...
  public void social_security_card_successful_test() {
    ...
    GetUserDefaultIdService getUserDefaultIdService =
        new GetUserDefaultIdService(userDao, user.getUsername(), documentType);
  ...
  public void retrieve_null_field_fail_test() {
    ...
    GetUserDefaultIdService getUserDefaultIdService =
        new GetUserDefaultIdService(userDao, user.getUsername(), getDocumentType);
    Message response = getUserDefaultIdService.executeAndGetResponse();
    String retrievedId = getUserDefaultIdService.getId(getDocumentType);
    User retrievedUser = getUserDefaultIdService.getUser();
  ...
  public void all_ids_successful_test() {
    ...
    GetUserDefaultIdService getUserDefaultIdService_ssc =
        new GetUserDefaultIdService(userDao, user.getUsername(), ssc_document);
    GetUserDefaultIdService getUserDefaultIdService_dl =
        new GetUserDefaultIdService(userDao, user.getUsername(), dl_document);
    GetUserDefaultIdService getUserDefaultIdService_bc =
        new GetUserDefaultIdService(userDao, user.getUsername(), bc_document);
    GetUserDefaultIdService getUserDefaultIdService_vc =
        new GetUserDefaultIdService(userDao, user.getUsername(), vc_document);
