...
public class UpdateOptionalUserInformationUnitTest {
  ...
  @Test
  public void success() throws IOException, ClassNotFoundException, ParseException {
    int year = 2023;
    ...
    assertEquals(
        "456 Elm St", updatedInfo.getBasicInfo().getResidentialAddress().getStreetAddress());
  ...
  @Test
  public void user_not_found() throws ParseException {
    CreateOptionalInfoService createOptionalInfoService =
        new CreateOptionalInfoService(
            optionalUserInformationDao,
            "testUser",
    ...
    OptionalUserInformation optionalUserInformationDifferentUsername =
        new OptionalUserInformation();
