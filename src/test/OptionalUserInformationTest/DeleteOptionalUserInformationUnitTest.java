...
public class DeleteOptionalUserInformationUnitTest {
  ...
  public void success() throws ParseException {
    ...
    DeleteOptionalInfoService deleteOptionalInfoService =
        new DeleteOptionalInfoService(optionalUserInformationDao, savedInfo.getUsername());
  ...
  @Test
  public void success2() throws ParseException {
    CreateOptionalInfoService createOptionalInfoService =
        new CreateOptionalInfoService(
            optionalUserInformationDao,
            "testUser",
    ...
    // Deleted second user
    DeleteOptionalInfoService deleteOptionalInfoService =
        new DeleteOptionalInfoService(optionalUserInformationDao, savedInfo1.getUsername());
    ...
    OptionalUserInformation notDeletedInfo =
        optionalUserInformationDao.get("testUser").orElse(null);
    assertNotNull(notDeletedInfo);
  }

  @Test
  public void username_not_found() throws ParseException {
    CreateOptionalInfoService createOptionalInfoService =
        new CreateOptionalInfoService(
            optionalUserInformationDao,
            "testUser",
    ...
    DeleteOptionalInfoService deleteOptionalInfoService =
        new DeleteOptionalInfoService(optionalUserInformationDao, "testUser1");
    Message response1 = deleteOptionalInfoService.executeAndGetResponse();
