...
public class GetOptionalUserInformationUnitTest {
  ...
  public void success() throws ParseException {
    ...
    GetOptionalInfoService getOptionalInfoService =
        new GetOptionalInfoService(optionalUserInformationDao, savedInfo.getUsername());
  ...
  @Test
  public void get_different_user() throws ParseException {
    CreateOptionalInfoService createOptionalInfoService =
        new CreateOptionalInfoService(
            optionalUserInformationDao,
            "testUser",
    ...
    GetOptionalInfoService getOptionalInfoService1 =
        new GetOptionalInfoService(optionalUserInformationDao, savedInfo1.getUsername());
  ...
  @Test
  public void no_user_found() throws ParseException {
    CreateOptionalInfoService createOptionalInfoService =
        new CreateOptionalInfoService(
            optionalUserInformationDao,
            "testUser",
    ...
    GetOptionalInfoService getOptionalInfoService =
        new GetOptionalInfoService(optionalUserInformationDao, "testUser1");
    Message response1 = getOptionalInfoService.executeAndGetResponse();
