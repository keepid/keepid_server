...
public class CreateOptionalInfoService implements Service {
    ...
    public CreateOptionalInfoService(
            ...
            String suffix, String birthFirstName, String birthMiddleName, String birthLastName,
            String birthSuffix, String stateIdNumber, Boolean haveDisability,
            ...
            boolean isVeteran, boolean isProtectedVeteran, String branch,
            String yearsOfService, String rank, String discharge
    ) {
    ...
    public OptionalUserInformation build() {
        ...
        FamilyInfo familyInfo = FamilyInfo.builder()
                .parents(parents)
        ...
        // Constructing OptionalUserInformation object
        OptionalUserInformation optionalUserInfo = OptionalUserInformation.builder()
                .username(username)
                .self(self)
                .basicInfo(basicInfo)
