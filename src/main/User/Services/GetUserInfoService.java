...
public class GetUserInfoService implements Service {
  ...
  /**
   * Returns a flattened map of all user fields including nested optionalInformation.
   * Keys use dot notation for nested objects (e.g., "optionalInformation.person.firstName")
   * and index notation for arrays (e.g., "optionalInformation.familyInfo.parents.0.firstName").
