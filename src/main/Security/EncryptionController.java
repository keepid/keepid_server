...
public class EncryptionController {
  ...
  //    Aead aead = new GcpKmsClient().withCredentials(credentials).getAead(masterKeyUri);
  //    KeysetHandle keysetHandle = KeysetHandle.read(JsonKeysetReader.withJsonObject(keyJson),
  // aead);
  //
