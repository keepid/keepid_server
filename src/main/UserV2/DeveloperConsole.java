...
public class DeveloperConsole {
  ...
  public static void main(String[] args)
      throws ValidationException, GeneralSecurityException, IOException, ParseException {
  ...
  public static void createDeveloper() throws GeneralSecurityException, IOException {
    ...
    //Commented above line because EncryptionUtils has version 1 User class already and Java does not support
    //Importing Classes with same name & with different alias.
