...
public class SubmitToLobMailService implements Service {
  ...
  public SubmitToLobMailService(
      ...
      String loggedInUser,
      String lobApiKey) {
    Mail mail = new Mail(new ObjectId(file_id), formMailAddress, username, loggedInUser);
    this.mail = mail;
  ...
  public Message executeAndGetResponse() {
    ...
    try {
      ...
      checkEditable.setFrom("adr_4013e5969cf5693d");
      ...
      byte[] pdfData = IOUtils.toByteArray(fileDao.getStream(mail.getFileId()).orElseThrow());
